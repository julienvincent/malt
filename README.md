...
You can verify if a protocol is a malt protocol by checking the `:malt/protocol` field on the var: `(:malt/protocol
#'UserStore)`
...
See cljfmt issue [weavejester/cljfmt#336][cljfmt-issue].
...
See clojure-lsp issue [clojure-lsp/clojure-lsp#2176][clojure-lsp-issue].
...
See implementation here: [schema/macros.clj][schema-macros] (line 417).
...
[cljfmt-issue]: https://github.com/weavejester/cljfmt/issues/336
[clojure-lsp-issue]: https://github.com/clojure-lsp/clojure-lsp/issues/2176
[schema-macros]: https://github.com/plumatic/schema/blob/master/src/clj/schema/macros.clj
